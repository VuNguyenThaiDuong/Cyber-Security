                    ...
                    Feature.innerHTML = `
                        <div class="mo_ta_ngan">
                            <p style="color:black; font-weight:bold; display: inline;">
                                ...
                                <button id="toggle-popup" class="nut_xem_them_mo_ta" style="color: yellow; background: none; border: none; cursor: pointer; padding: 5px 10px; font-weight: bold; border-radius: 5px; margin-left: 10px;"><i class="fas fa-plus-circle"></i> Xem thêm</button>
                            </p>
                        </div>
